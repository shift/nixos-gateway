# Enhanced BGP Routing Example
# This example demonstrates the comprehensive BGP routing capabilities implemented in Task 09

{
  description = "NixOS Gateway with Enhanced BGP Routing";
  ...
  outputs =
    ...
    flake-parts.lib.mkFlake { inherit inputs; } {
      ...
      flake = {
        # Enhanced BGP gateway configuration
